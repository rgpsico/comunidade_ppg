...
<head>
  ...
  {{-- WhatsApp usa og: acima, mas descrição extra ajuda --}}
  <meta name="description" content="{{ $ogDesc }}">

  {{-- Redireciona usuário real pro SPA após 0ms --}}
...
<body style="margin:0;background:#0f0e0c;color:#f5f0e8;font-family:sans-serif;display:flex;align-items:center;justify-content:center;min-height:100vh;text-align:center;">
  <div>
    ...
    <p style="font-size:18px;font-weight:700;">{{ $vaga->titulo }}</p>
    <p style="font-size:13px;color:#aaa;margin-top:4px;">{{ $vaga->empresa }}</p>
